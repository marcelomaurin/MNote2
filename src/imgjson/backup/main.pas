...
uses
  ...
  About, setmain, config, EditBtn, ExtCtrls, ComCtrls, Grids,
...
procedure Tfrmmain.mnSalvarClick(Sender: TObject);
begin
...
procedure Tfrmmain.miMakeTesteClick(Sender: TObject);
var
   item : TNNTrainning;
   arquivo : Tstringlist;
   marca : string;
...
procedure Tfrmmain.miMakeTrainningClick(Sender: TObject);
var
   item : TNNTrainning;
   arquivo : Tstringlist;
begin
...
procedure Tfrmmain.miNewItemClick(Sender: TObject);
begin
  NewNNTrainning();
end;

procedure Tfrmmain.miruntrainningClick(Sender: TObject);
var
   item : TNNTrainning;
   arquivo : Tstringlist;
...
procedure Tfrmmain.mitrainningClick(Sender: TObject);
var
...
procedure Tfrmmain.miQueryClick(Sender: TObject);
begin
  NewQuery();
end;
...
begin
  ...
  frmconfig.edFileDLL.Text:= FSetMain.DLLPath;
  frmconfig.showmodal();
  if (frmconfig.flgsalvar) then
  begin
    FSetMain.DLLPath := frmconfig.edFileDLL.Text;
...
procedure Tfrmmain.nmOpenClick(Sender: TObject);
begin
  if(AbreProjeto()) then
  begin
...
procedure Tfrmmain.SairPrograma;
begin
  close;
end;

procedure Tfrmmain.ChamaAbout;
begin
...
procedure Tfrmmain.FechaProjeto;
begin

end;

procedure Tfrmmain.CriaProjeto;
begin
...
procedure Tfrmmain.NewNNTrainning();
var
...
procedure Tfrmmain.NewNNTrainning(sql: string);
begin
  //Precisa implementar tela de trainamento
...
procedure Tfrmmain.RegistraQuery(Nome: string; sql: string);
var
  item : TSQLEditItem;
...
procedure Tfrmmain.IncluiQuery(Nome: string; sql: string);
var
  item : TSQLEditItem;
...
procedure Tfrmmain.RegistraNNTrainning(nome: string; comentario: string;
...
procedure Tfrmmain.IncluiNNTrainning(
  nome: string;
  comentario: string;
  sqlitemtrainning: TSQLEditItem;
  sqlitemtest: TSQLEditItem;
...
procedure Tfrmmain.CarregaQuerys();
var
  a : integer;
  nome : string;
  sql : string;
...
procedure Tfrmmain.CarregaNNTrainning;
var
  a : integer;
  nome : string;
  comentario: string;
...
procedure Tfrmmain.CarregaProjeto;
begin
  if ( Fsetproject <> nil) then
  begin
...
procedure Tfrmmain.CarregaDatabase();
var
  filename : string;
begin
  if (dmBase =nil) then
  begin
    try
       ...
       begin
         ...
         filename := FSetMain.DLLPath+'\libs\mysql\win64\lib64\libmysql.dll';
...
function Tfrmmain.AbreProjeto: boolean;
begin
...
function Tfrmmain.AbreProjetofield: boolean;
var
  nome : string;
  filename : string;
begin
...
procedure Tfrmmain.TreinaRedeNN(item: TSQLEditItem);
begin
     NewNNTrainning();
end;

procedure Tfrmmain.controlelog(Sender: TObject; const OutputLine: String);
begin
